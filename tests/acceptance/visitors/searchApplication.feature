Feature: search application for stores
    ...
    Given I enter in the search bar "Store" and am on page "/Main/index" and choose option "Search By Store"
    When I click "Search"
    Then I see "Store"

    Scenario: try searching for a store that isn't registered
    Given I enter in the search bar "Puppy" and am on page "/Main/index" and choose option "Search By Store"
    When I click "Search"
