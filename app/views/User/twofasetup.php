<html>
    ...
    <h1>2 Factor Authentication Setup</h1> <br>
    <img src= "http://localhost/User/makeQRCode?data=<?= $data ?>" alt = "problem" style = 'max-width:200px;max-height:200px;display:block;margin-left:auto;margin-right:auto;'/> <br>
        ...
        <form method="post" action="">
            <label class = 'form-label'>Current code:<input class = 'form-control' type="text" name="currentCode"
            /></label> <br>
            <input class = 'btn btn-primary' type="submit" name="2fa" value="Verify code" />
            <input class = 'btn btn-primary' type="submit" name="no_2fa" value="Skip 2FA" />
        </form>
    </body>
</html>