<h1>Store details</h1>
	<form method='post' action=''>
		...
		<label class='form-label'>Description:<textarea name='notes' class='form-control'><?= $data->description?></textarea></label><br>
    </form>
    <?php   
        $this->view('subviews/products', $data->getProducts($data->store_id));
    ?>  
