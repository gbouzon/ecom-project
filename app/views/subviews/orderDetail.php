    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class='card'>
                ...
                <div class='card-body'>
                    <label class='form-label'> <span style='font-size:110%;'>Store name: </span> <?= $data[0]->store_name?></label><br>
                    <label class='form-label'> <span style='font-size:110%;'>Store address:</span> <?= $data[0]->store_address?></label><br>
                    <label class='form-label'><span style='font-size:110%;'>Store description:</span> <?= $data[0]->description?></label><br>
			    </div>
            </div>
        </div>
    </div>        
